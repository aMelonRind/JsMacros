...
//        }
        ...
        PACKETS.put("AcceptCodeOfConductC2SPacket", net.minecraft.network.protocol.configuration.ServerboundAcceptCodeOfConductPacket.class);
        ...
        PACKETS.put("BlockValueDebugS2CPacket", net.minecraft.network.protocol.game.ClientboundDebugBlockValuePacket.class);
        ...
        PACKETS.put("BundleItemSelectedC2SPacket", net.minecraft.network.protocol.game.ServerboundSelectBundleItemPacket.class);
        ...
        PACKETS.put("ChangeGameModeC2SPacket", net.minecraft.network.protocol.game.ServerboundChangeGameModePacket.class);
        ...
        PACKETS.put("ChunkValueDebugS2CPacket", net.minecraft.network.protocol.game.ClientboundDebugChunkValuePacket.class);
        PACKETS.put("ClearDialogS2CPacket", net.minecraft.network.protocol.common.ClientboundClearDialogPacket.class);
        ...
        PACKETS.put("ClientTickEndC2SPacket", net.minecraft.network.protocol.game.ServerboundClientTickEndPacket.class);
        ...
        PACKETS.put("CodeOfConductS2CPacket", net.minecraft.network.protocol.configuration.ClientboundCodeOfConductPacket.class);
        ...
        PACKETS.put("CustomClickActionC2SPacket", net.minecraft.network.protocol.common.ServerboundCustomClickActionPacket.class);
        ...
        PACKETS.put("DebugSubscriptionRequestC2SPacket", net.minecraft.network.protocol.game.ServerboundDebugSubscriptionRequestPacket.class);
        ...
        PACKETS.put("EntityPositionSyncS2CPacket", net.minecraft.network.protocol.game.ClientboundEntityPositionSyncPacket.class);
        ...
        PACKETS.put("EntityValueDebugS2CPacket", net.minecraft.network.protocol.game.ClientboundDebugEntityValuePacket.class);
        PACKETS.put("EntityVelocityUpdateS2CPacket", net.minecraft.network.protocol.game.ClientboundSetEntityMotionPacket.class);
        PACKETS.put("EventDebugS2CPacket", net.minecraft.network.protocol.game.ClientboundDebugEventPacket.class);
        ...
        PACKETS.put("GameTestHighlightPosS2CPacket", net.minecraft.network.protocol.game.ClientboundGameTestHighlightPosPacket.class);
        ...
        PACKETS.put("MoveMinecartAlongTrackS2CPacket", net.minecraft.network.protocol.game.ClientboundMoveMinecartPacket.class);
        PACKETS.put("NbtQueryResponseS2CPacket", net.minecraft.network.protocol.game.ClientboundTagQueryPacket.class);
        PACKETS.put("OpenMountScreenS2CPacket", net.minecraft.network.protocol.game.ClientboundMountScreenOpenPacket.class);
        ...
        PACKETS.put("PickItemFromBlockC2SPacket", net.minecraft.network.protocol.game.ServerboundPickItemFromBlockPacket.class);
        PACKETS.put("PickItemFromEntityC2SPacket", net.minecraft.network.protocol.game.ServerboundPickItemFromEntityPacket.class);
        ...
        PACKETS.put("PlayerLoadedC2SPacket", net.minecraft.network.protocol.game.ServerboundPlayerLoadedPacket.class);
        ...
        PACKETS.put("PlayerRotationS2CPacket", net.minecraft.network.protocol.game.ClientboundPlayerRotationPacket.class);
        ...
        PACKETS.put("RecipeBookAddS2CPacket", net.minecraft.network.protocol.game.ClientboundRecipeBookAddPacket.class);
        PACKETS.put("RecipeBookDataC2SPacket", net.minecraft.network.protocol.game.ServerboundRecipeBookSeenRecipePacket.class);
        PACKETS.put("RecipeBookRemoveS2CPacket", net.minecraft.network.protocol.game.ClientboundRecipeBookRemovePacket.class);
        PACKETS.put("RecipeBookSettingsS2CPacket", net.minecraft.network.protocol.game.ClientboundRecipeBookSettingsPacket.class);
        ...
        PACKETS.put("SetCursorItemS2CPacket", net.minecraft.network.protocol.game.ClientboundSetCursorItemPacket.class);
        PACKETS.put("SetPlayerInventoryS2CPacket", net.minecraft.network.protocol.game.ClientboundSetPlayerInventoryPacket.class);
        PACKETS.put("SetTestBlockC2SPacket", net.minecraft.network.protocol.game.ServerboundSetTestBlockPacket.class);
        PACKETS.put("SetTradeOffersS2CPacket", net.minecraft.network.protocol.game.ClientboundMerchantOffersPacket.class);
        PACKETS.put("ShowDialogS2CPacket", net.minecraft.network.protocol.common.ClientboundShowDialogPacket.class);
        ...
        PACKETS.put("TestInstanceBlockActionC2SPacket", net.minecraft.network.protocol.game.ServerboundTestInstanceBlockActionPacket.class);
        PACKETS.put("TestInstanceBlockStatusS2CPacket", net.minecraft.network.protocol.game.ClientboundTestInstanceBlockStatus.class);
        ...
        PACKETS.put("WaypointS2CPacket", net.minecraft.network.protocol.game.ClientboundTrackedWaypointPacket.class);
